...
const val page3screenval = "com.example.page3screen"

class page2screen : AppCompatActivity(), SensorEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_page2_screen)
    ...
    override fun onSensorChanged(event: SensorEvent?) {
        ...
        if (running && event != null) {
            ...
            MainActivity.totalSteps += stepsSinceLastUpdate
            MainActivity.previousTotalSteps = currentSteps
            ...
            if (totalStepsInt >= 30000) Button2.setVisibility(View.VISIBLE)
    ...
    fun backToLastPage(view: View) {
        val intent = Intent(this, page1screen::class.java).apply {
            putExtra(
                "previousTotalSteps",
                MainActivity.previousTotalSteps
            ) // Pass current step count back to MainActivity
        }
        startActivity(intent)
    }

    fun Button2onclick1(view: View){
        var ResetButton = findViewById<TextView>(R.id.ResetButton)
        val message = ResetButton.text.toString()
        val intent = Intent(this, page3screen::class.java).apply {
            putExtra(page3screenval, message)
            putExtra("previousTotalSteps", MainActivity.previousTotalSteps)
        }
        startActivity(intent)
    }
