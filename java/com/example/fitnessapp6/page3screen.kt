...
const val pageFINALscreenval = "com.example.pagefinalscreen"

class page3screen : AppCompatActivity(), SensorEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_page3_screen)
    ...
    fun Button2onclick1(view: View) {
        ...
        val intent = Intent(this, pagefinalscreen::class.java).apply {
            putExtra(pageFINALscreenval, message)
