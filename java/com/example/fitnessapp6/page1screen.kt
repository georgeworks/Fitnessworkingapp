...
const val page2screenval = "com.example.page2screen"
const val stampscreenval = "com.example.stampscreen"


class page1screen : AppCompatActivity(), SensorEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_page1_screen)
    ...
    override fun onSensorChanged(event: SensorEvent?) {
        ...
        if (running && event != null) {
            ...
            if (totalStepsInt >= 25000) Button2.setVisibility(View.VISIBLE)
    ...
    fun Button2onclick(view: View) {
        ...
        val intent = Intent(this, page2screen::class.java).apply {
            putExtra(page2screenval, message)
            putExtra("previousTotalSteps", MainActivity.previousTotalSteps)
        }
        startActivity(intent)

    }
    fun stampscreen(view: View) {

        var ResetButton = findViewById<TextView>(R.id.ResetButton)
        val message = ResetButton.text.toString()
        val intent = Intent(this, stampscreen::class.java).apply {
            putExtra(stampscreenval, message)
            putExtra("previousTotalSteps", MainActivity.previousTotalSteps)
        }
        startActivity(intent)
