...
class pagefinalscreen : AppCompatActivity(), SensorEventListener {
    ...
    private fun saveData() {
        ...
        editor.putBoolean("ChinaView", MainActivity.ChinaView)
        editor.apply()
    }
    ...
    fun ButtonBacktoMain(view: View) {
        // Set ChinaView to false
        MainActivity.ChinaView = false
